    ...
    def generate(self, dest_dir):
        ...
        for file_path, elements in self.pages.items():
            for element in elements:
                replace_final_tag = utils.insert_in_file(
                    self._render(element), dest_dir / file_path, "{{" + element + "}}")

            # replace final autogenerated tag
            if replace_final_tag:
                utils.insert_in_file("", dest_dir / file_path, "{{autogenerated}}")
